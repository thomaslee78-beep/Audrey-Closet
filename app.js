...
async function init(){
  ...
  if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js?v=13.9-dev2',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{});
  renderAll();
}
