...
async function init(){
  ...
  if('serviceWorker'in navigator)navigator.serviceWorker.register('./sw.js?v=13.11-dev5',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{});
  renderAll();
}
