/* Audrey Closet v13.22 Board Focus Mode dev11
 * Replaces dev9/dev10 Text-reveal behavior with a stricter rule:
 * - switching Decorate sub-tabs never changes scroll position
 * - only focusing the actual text input may reveal the editor
 * - keeps accepted Draw color-picker and Canvas-spacing polish
 * - trims the main workspace visual buffer to 2px
 */
(function(){
  'use strict';

  const STYLE_ID='boardFocusDev11Styles';
  let revealTimer=0;
