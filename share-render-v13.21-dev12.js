 ...
 * Photo Studio layout dev2, and Share modal scroll locking.
 */
(function(){
  'use strict';
  ...
  const PHOTO_STUDIO_LAYOUT='13.23-photo-studio-layout-dev2';
  ...
  const modules=[
    ...
    'photo-studio-layout-v13.23-dev2.js?v='+PHOTO_STUDIO_LAYOUT,
