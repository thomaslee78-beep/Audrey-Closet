 ...
 * Photo Studio layout dev5 + Clean polish dev5a-dev5f + rail blend dev5h + Cutout dev6-dev6g,
...
(function(){
  ...
  const PHOTO_STUDIO_LAYOUT='13.23-photo-studio-layout-dev6g';
  ...
  const modules=[
    ...
    'photo-studio-cutout-guide-settings-final-v13.23-dev6g.js?v='+PHOTO_STUDIO_LAYOUT,
