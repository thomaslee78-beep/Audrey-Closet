 ...
 * Photo Studio layout dev5 + Clean polish dev5a-dev5f + rail blend dev5h + Cutout dev6-dev6h + Adjust dev7 + Background dev8 + menu labels dev8b,
...
(function(){
  ...
  const PHOTO_STUDIO_LAYOUT='13.23-photo-studio-layout-dev8b';
