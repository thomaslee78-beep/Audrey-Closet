 ...
 * Photo Studio layout dev4, and Share modal scroll locking.
 */
(function(){
  'use strict';
  ...
  const PHOTO_STUDIO_LAYOUT='13.23-photo-studio-layout-dev4';
  ...
  const modules=[
    ...
    'photo-studio-layout-v13.23-dev4.js?v='+PHOTO_STUDIO_LAYOUT,
