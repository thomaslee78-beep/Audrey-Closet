 ...
 * Photo Studio layout dev3 rollback, and Share modal scroll locking.
 */
(function(){
  'use strict';
  ...
  const PHOTO_STUDIO_LAYOUT='13.23-photo-studio-layout-dev3-rollback';
  ...
  const modules=[
    ...
    'photo-studio-layout-v13.23-dev3.js?v='+PHOTO_STUDIO_LAYOUT,
