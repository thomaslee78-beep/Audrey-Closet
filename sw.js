const CACHE='audrey-closet-v13.21-dev9';
...
(function(){
  ...
  function installClosetTierStyles(){
    ...
    style.textContent=[
      ...
      '.screen[data-screen="outfits"] .text-font-align-row{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:6px;align-items:center;min-width:0}',
      ...
      '.screen[data-screen="outfits"] .text-action-stack{display:grid;grid-template-rows:repeat(3,36px);gap:5px;min-width:92px;align-content:start}',
      '.screen[data-screen="outfits"] .text-entry-action-row{align-items:stretch}',
      '.screen[data-screen="outfits"] .text-entry-action-row #boardTextInput{height:118px;min-height:118px;max-height:118px;resize:none;box-sizing:border-box}',
