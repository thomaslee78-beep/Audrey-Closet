const CACHE='audrey-closet-v13.21-dev8';
...
(function(){
  ...
  function installClosetTierStyles(){
    ...
    style.textContent=[
      ...
      '.screen[data-screen="outfits"] .text-action-stack{display:grid;grid-template-rows:minmax(68px,1fr) 34px 36px;gap:6px;min-width:92px}',
